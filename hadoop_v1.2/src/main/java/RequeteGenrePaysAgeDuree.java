...
public class RequeteGenrePaysAgeDuree {
    ...
    public static class StatsTuple implements WritableComparable<StatsTuple> {
        ...
        public StatsTuple(String pays, String age,String genre) {
            this.pays = pays;
            this.age = age;
            this.genre = genre;
        }
    ...
    public static class JoinMapper extends Mapper<LongWritable, Text, StatsTuple, DoubleWritable> {
        ...
        HashMap<String,StatsTuple> contenuGenre = new HashMap<>();
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            ...
            try (BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(new Path(INPUT_PATH_CONTENU))))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    // Supposons: Index 0 = ID, Index 5 = Genre
                    if (parts.length > 5) {
                        contenuGenre.put(parts[0],new StatsTuple("","",parts[5]));
                    }
                }
            }
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if(!line.contains("ID_CONTENU")) {
                if (((FileSplit) context.getInputSplit()).getPath().getName().contains("fact")) { // mettre un identifiant
                    ...
                    StatsTuple genre = contenuGenre.get(idContenu);

                    double duree = Double.parseDouble(words[7]);

                    context.write(new StatsTuple(payAge.pays,payAge.age,genre.genre),new DoubleWritable(duree));
